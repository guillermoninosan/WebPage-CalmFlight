...
export default function CalmCards() {
    ...
    const cardsData = {
        en: [
            ...
            { id: 6, title: "Turbulence", text: "Turbulence is like a boat on waves. The air isn't thin; it's supporting the plane from all sides. You are safe, just bumpy.", snippet: "Turbulence is uncomfortable but safe. The air supports the plane like water supports a boat." },
            { id: 7, title: "Why flying is so safe", text: "Aviation is the safest transport mode because of redundancy. Every critical system has 2-3 backups, and pilots train constantly for rare events.", snippet: "Flying is safe because of redundancy. Every system has backups, and pilots are trained for every scenario." }
        ],
        es: [
